...
@RestController
@Api(tags ="Diary Posts", value = "Diary Post Controller API Documentation")
...
public class DiaryPostsController {
    ...
    @ApiOperation(value = "Shows every post.",
            notes = "Used for getting the every post in the diary database. It shouldn't be accessible because diaries are personal. " +
    ...
    @ApiOperation(value = "Shows posts from user.",
            notes = "To see diary posts from the user with the given username. We are passing the username as a path variable. If the user doesn't exist, it will return null." +
    ...
    @ApiOperation(value = "To see a specific post in the diary database.",
            notes = "We are passing the postId. If the post doesn't exist, it will return null.")
    ...
    @ApiOperation(value = "To update a specific post in the diary database.",
            notes = "We are passing the postId as a path variable, JSON Body for the updated title and content. If the post doesn't exist, it will return null.")
    ...
    @ApiOperation(value = "To update a specific post in the diary database of the given username.",
            notes = "We are passing the update request with the JSON body. If the username has a post with the given postId, it will update the post." +
                    "If the username doesn't have a post with the given postId, it will return a message accordingly.")
    ...
    @ApiOperation(value = "To delete a specific post in the diary database of the given username.",
            notes = "We are passing the delete request with the JSON body. If the username has a post with the given postId, it will delete the post. " +
    ...
    @ApiOperation(value = "To delete all the posts in the database.",
            notes = "This is here for the testing purposes.")
